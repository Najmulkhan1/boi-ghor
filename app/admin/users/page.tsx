    ...
    <div className="space-y-6 relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-800 pb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-white">ইউজার ও রোল ম্যানেজমেন্ট</h1>
            <p className="text-sm text-slate-500">ইউজারদের রোল পরিবর্তন করুন এবং ক্রেডিট ম্যানেজ করুন।</p>
          </div>
        </div>
      ...
      <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-sm">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-800/70 border-b border-slate-700 text-slate-400 text-xs uppercase tracking-widest font-bold">
            ...
            {filteredUsers.map((user) => (
              <tr key={user._id} className="hover:bg-slate-800/40 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-bold overflow-hidden border border-indigo-500/20">
                      {user.avatar ? (
                ...
                <td className="px-6 py-4">
                  <select 
                    ...
                    className="text-xs border border-slate-700 rounded-lg p-1.5 focus:ring-2 focus:ring-indigo-500 bg-slate-800 text-white font-medium cursor-pointer outline-none"
                  >
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <Input 
                      ...
                      className="w-20 h-8 text-xs font-bold bg-slate-800 border-slate-700 text-white"
                      onBlur={(e) => {
                  ...
                  <div className="flex items-center justify-center gap-2">
                    {updating === user._id ? (
                      ...
                      <Button
                        ...
                        className="gap-2 border-slate-700 text-slate-300 hover:bg-slate-700 hover:text-white h-8"
                      >
        ...
        {filteredUsers.length === 0 && (
          <div className="text-center py-10 text-slate-500">কোনো ইউজার পাওয়া যায়নি।</div>
        )}
      </div>
