...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-[60vh]">
        ...
        <h2 className="text-2xl font-bold text-gray-700 mb-2">আপনার কার্ট একদম ফাঁকা!</h2>
        <p className="text-gray-500 mb-6">হার্ডকপি বই কিনে কার্ট ভর্তি করুন।</p>
  ...
  return (
    <div className="container mx-auto px-4 py-10 max-w-6xl">
      <h1 className="text-3xl font-extrabold text-gray-900 mb-8">আপনার শপিং কার্ট</h1>
        ...
        <div className="lg:col-span-4">
          <Card className="sticky top-24 border-gray-200 shadow-sm">
            <CardContent className="p-6 space-y-4">
              <h3 className="text-xl font-bold border-b pb-4">অর্ডার সামারি</h3>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-2xl font-extrabold text-blue-700">৳{grandTotal}</span>
              </div>

              <Button className="w-full bg-blue-600 hover:bg-blue-700 h-12 text-lg gap-2 mt-4" asChild>
                <Link href="/checkout">
