      ...
      <div className="w-1/2 relative p-2.5 sm:p-3 bg-gradient-to-l from-[#f0ebe1]/40 to-[#faf9f6] flex flex-col z-10">
        ...
        <div className="mb-2">
          <Link href={`/books/${book.slug}`}>
            <h3
              className="font-bold text-xs sm:text-sm text-gray-900 leading-tight group-hover:text-blue-700 transition-colors line-clamp-2"
              title={book.title}
            >
              {book.title}
            </h3>
          ...
          <p className="text-[10px] sm:text-xs text-gray-500 mt-0.5">
            <Link
              ...
              className="hover:text-blue-600 hover:underline transition-colors line-clamp-1"
            >
              {book.authorName}
            </Link>
          </p>
        ...
        <div className="mt-auto flex flex-col gap-1">
          <div className="flex items-center justify-between bg-blue-50/70 border border-blue-100/50 px-1.5 py-1 rounded">
            <span className="text-[8px] sm:text-[9px] uppercase font-bold text-blue-600/80">
              Digital
            </span>
          ...
          {book.hardCopyAvailable && (
            <div className="flex items-center justify-between bg-emerald-50/70 border border-emerald-100/50 px-1.5 py-1 rounded">
              <span className="text-[8px] sm:text-[9px] uppercase font-bold text-emerald-600/80">
                Hard Copy
              </span>
